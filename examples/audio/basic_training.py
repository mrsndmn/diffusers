...
Original file is located at
    https://colab.research.google.com/github/huggingface/notebooks/blob/main/diffusers_doc/en/pytorch/basic_training.ipynb
...
dataset = load_dataset(config.dataset_name, split="train", download_mode="reuse_dataset_if_exists")
...
def print_tensor_statistics(tensor_name, tensor):
    print(f"{tensor_name} [{tensor.shape}]: min={tensor.min()}, max={tensor.max()}, median={tensor.median()}, mean={tensor.mean()}")
    ...
    for epoch in range(config.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(model):
                ...
                print_tensor_statistics("noisy_images", noisy_images)
                print_tensor_statistics("clean_images", clean_images)
