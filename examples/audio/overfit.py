...
class TrainingConfig:
    sample_size = 64  # the generated image resolution
...
def process_audio_encodec(encodec_processor, encodec_model, examples):
    ...
    for audio in examples['audio']:
        ...
        batch.append( _process_audio_encodec(encodec_processor, encodec_model, example)['audio_codes'] )
...
if __name__ == '__main__':
    ...
    audio_mnist_dataset_24khz_processed = audio_mnist_dataset_24khz
