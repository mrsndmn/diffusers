...
audio_mnist_dataset: datasets.Dataset = load_dataset("audiofolder", data_dir="AudioMNIST/data_normalized")
...
audio_mnist_dataset.save_to_disk("./audio_mnist_full_60_speakers_normalized_encodec_processed")
