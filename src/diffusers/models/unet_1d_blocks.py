...
def get_down_block(
    ...
    temb_channels: int,
    add_downsample: bool,
    attention_head_dim: Optional[int] = None,   # todo use it in AttnDownBlock1D
    num_attention_heads: Optional[int] = None,  # todo use it in AttnDownBlock1D
) -> DownBlockType:
